...
it.only('testa a página da política de privacidade de forma independente', function(){ //o primeiro argumento do bloco "it" é o nome do test case, e segundo argumento é a função de callback
